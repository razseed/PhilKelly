...
function colorChange(){
    ...
    document.getElementById("telephoneCallHandler").style.width = '17vw';
    document.getElementById("telephoneCallHandler").style.height = '11vh';
}
...
function colorChangeRevert(){
    ...
    document.getElementById("telephoneCallHandler").style.width = '16vw';
    document.getElementById("telephoneCallHandler").style.height = '10vh';
}
